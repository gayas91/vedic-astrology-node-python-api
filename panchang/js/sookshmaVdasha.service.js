...
function translateSookshmaResponse(data, lang) {
...
module.exports = function getSookshmaVdasha(maha, antar, pratyantar, start, lang = "en") {
    return new Promise((resolve, reject) => {
        const script = path.join(__dirname, "../python/sookshma_vdasha.py");
        ...
        execFile(PYTHON, [script, JSON.stringify(payload)], (err, stdout, stderr) => {
            ...
            try {
                ...
                const finalData = translateSookshmaResponse(parsed, safeLang);
                resolve(finalData);
            } catch (e) {
